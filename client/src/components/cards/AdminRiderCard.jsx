...
export default function AdminRiderCard({
  ...
  return (
    <div className="grid w-full grid-cols-1 gap-4 mx-auto md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      {orders.map((order) => (
        <div
          key={order.order_no}
          className="w-full max-w-lg p-4 bg-orange-100 border border-black rounded-md shadow-md"
        >
          ...
          {/* Buttons */}
          <div className="grid grid-cols-2 gap-3 mt-3 text-xl md:grid-cols-4 place-items-center">
            <button
              className={`w-full h-[40px] border-2 border-black rounded-lg text-white ${
            ...
            <button
              className={`w-full h-[40px] bg-blue-500 border-2 border-black rounded-lg text-white ${
            ...
            <button
              className="w-full h-[40px] bg-green-500 border-2 border-black rounded-lg text-white hover:bg-green-400 hover:text-slate-100"
            ...
            <button
              className="w-full h-[40px] bg-red-500 border-2 border-black rounded-lg text-white hover:bg-red-400 hover:text-slate-100"
